    ...
    <div className="flex flex-1 flex-col gap-6 p-4 md:p-6 lg:p-8">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary via-primary/90 to-primary/70 p-6 md:p-8 text-primary-foreground">
        <div className="relative z-10">
          <p className="text-sm font-medium opacity-80 mb-1">Selamat datang kembali 👋</p>
          ...
          <Button variant="secondary" className="rounded-full font-semibold shadow-lg">
            ...
            <CardContent className="p-4 md:p-5">
              <div className="flex items-center justify-between mb-3">
                <div className={`flex h-10 w-10 items-center justify-center rounded-xl ${stat.bg}`}>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`size-5 ${stat.color}`}>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium truncate group-hover:text-primary transition-colors">{submission.title}</p>
                    <p className="text-xs text-muted-foreground">{submission.type} · {submission.updatedAt}</p>
                  </div>
                  <Badge variant={config.variant} className="shrink-0 rounded-full text-xs">
                    {config.label}
                  </Badge>
                </Link>
              );
